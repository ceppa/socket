...
int loadScenariBgBnTable(bool onlyupdate)
{
	...
	if(!onlyupdate)
	{
		if(SCENARIBGBNCOUNT)
		{
			printf("get_shared_memory_segment: scenariBgBnTable\n");
		...
		printf("get_shared_memory_segment: buonGiornoAttivo\n");
		...
		printf("get_shared_memory_segment: buonaNotteAttivo\n");
...
int loadScenariPresenzeTable(bool onlyupdate)
{
	...
	if(!onlyupdate)
	{
		...
		{
			printf("get_shared_memory_segment: scenariPresenzeTable\n");
		...
		printf("get_shared_memory_segment: scenariPresenzeAttivo\n");
