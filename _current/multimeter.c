...
void doMultimeter(int l)
{
	...
	my_printf("address %s, port %d connected\n",multimeters[l].address, multimeters[l].port);
	...
	do
	{
		...
		if(out==-1)
		{
			handleMessage(0,0,multimeters[l].multimeter_num,0,"MULTIMETER DISCONNECTED",0,-1);
...
*/
	...
	handleMessage(0,0,multimeters[multimeterId].multimeter_num,0,"MULTIMETER CONNECTED",0,-1);
